...
export default function MergeTomeTable({
  dispatch,
  duplicateNumbers,
  tomes,
}: MergeTomeTableProps) {
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        dispatch({
                          type: "UPDATE_TOME",
                          index,
                          patch: { number: parseInt(e.target.value, 10) || 1 },
                        })
                      }
                      type="number"
                      value={tome.number}
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        dispatch({
                          ...
                          index,
                          patch: {
                            tomeEnd: v ? parseInt(v, 10) || null : null,
                          },
                        });
                      }}
                      placeholder="-"
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        dispatch({
                          type: "UPDATE_TOME",
                          index,
                          patch: { isbn: e.target.value || null },
                        })
                      }
                      placeholder="-"
                      type="text"
