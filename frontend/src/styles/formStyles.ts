...
export const formInputFocusClassName = `${formInputClassName} ${formFocusRing}`;
...
export const formInputSecondaryFocusClassName = `${formInputSecondaryClassName} ${formFocusRing}`;
...
export const formListboxButtonClassName = `flex w-full items-center justify-between gap-2 ${formInputClassName} transition hover:border-primary-400 ${formFocusRing}`;

/** Bouton Listbox variante bg-surface-secondary (modales de fusion) */
export const formListboxButtonSecondaryClassName = `flex w-full items-center justify-between gap-2 ${formInputSecondaryClassName} transition hover:border-primary-400 ${formFocusRing}`;

/** Select natif avec focus ring (padding légèrement plus grand) */
export const formSelectClassName = `${formInputClassName.replace("py-2.5", "py-3")} ${formFocusRing}`;
...
export const formCheckboxFocusClassName = `${formCheckboxClassName} focus:ring-primary-500`;
