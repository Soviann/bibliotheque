 ...
 */
final class Version20260130164126 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Schéma initial : tables author, comic_series, tome, user';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comic_series (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, status VARCHAR(20) NOT NULL, type VARCHAR(20) NOT NULL, latest_published_issue INT DEFAULT NULL, latest_published_issue_complete TINYINT NOT NULL, is_wishlist TINYINT NOT NULL, cover_image VARCHAR(255) DEFAULT NULL, cover_url VARCHAR(500) DEFAULT NULL, created_at DATETIME NOT NULL, description LONGTEXT DEFAULT NULL, published_date VARCHAR(50) DEFAULT NULL, publisher VARCHAR(255) DEFAULT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
