...
> Règles partagées (Approach, Plans, Quality, Coding Standards, Git, Translations, Language, Recommended Plugins) injectées par le plugin `soviann-conventions@soviann-tools` via SessionStart hook (`rules.md`). Voir `Soviann/claude-marketplace`.
